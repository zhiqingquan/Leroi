        ...
        MODULE HSBOSS__genmod
          INTERFACE 
            SUBROUTINE HSBOSS(NFRQ,FREQ,SOURCE_TYPE,NTX,MXVRTX,NVRTX,SXN&
     &,SXE,SXZ,SXDIP,SXAZM,NRXTX,MRXTX,RXID,MQVR,XRXTX,YRXTX,ZRXTX,MXRHO&
     &,RHOTRP,NLYR,THKD,RES,RMUD,REPS,CHRG,CTAU,CFREQ,BFD)
              INTEGER(KIND=4) :: NLYR
