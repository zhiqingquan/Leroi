        ...
        MODULE PRM_BOSS_MD__genmod
          INTERFACE 
            SUBROUTINE PRM_BOSS_MD(FRQ,NTX,SXN,SXE,SXZ,SXDIP,SXAZM,NRPRM&
     &,RHOTRP,NLYR,THKD,DPTHL,RMUD,SIGL,KSQL,NPLT,PLAZM,PLDIP,PLUNJ,MXAB&
     &,NB,NA,XCELL,YCELL,ZCELL,NZ1,ZV1,E_PRYM)
          ...
          END INTERFACE 
        END MODULE PRM_BOSS_MD__genmod
