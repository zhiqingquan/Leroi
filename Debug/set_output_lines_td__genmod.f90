        ...
        MODULE SET_OUTPUT_LINES_TD__genmod
          INTERFACE 
            SUBROUTINE SET_OUTPUT_LINES_TD(NCHNL,NTX,MRXTX,NRXTX,NLINES,&
     &MRXL,MCMP,NRX,LNTR,KNORM2,RX_TYPE,UNITS,ISYS,IDH,SVAZM,MD1,MD2,   &
     &RXAZM,RXDIP,CURNT,BPRM,BTD,BFTL)
              INTEGER(KIND=4) :: MD2
              INTEGER(KIND=4) :: MD1
              INTEGER(KIND=4) :: MCMP
              INTEGER(KIND=4) :: MRXL
          ...
          END INTERFACE 
        END MODULE SET_OUTPUT_LINES_TD__genmod
