        ...
        MODULE EGT_OUT_BOSS__genmod
          INTERFACE 
            SUBROUTINE EGT_OUT_BOSS(NPLT,MXAB,NA,NB,PLAZM,PLDIP,PLUNJ,  &
     &XCELL,YCELL,ZCELL,NLYR,THKD,DPTHL,RMUD,SIGL,KSQL,NTX,MRXTX,NRXTX, &
     &RXID,MXRS,NRS,XRS,YRS,ZRXTX,WTRS,NRMGT,RHOTRP,NZ1,ZV1,NMGP,XMG,YMG&
     &,ZMG,WMG,HA,HB)
              INTEGER(KIND=4) :: NMGP
              INTEGER(KIND=4) :: NZ1
          ...
          END INTERFACE 
        END MODULE EGT_OUT_BOSS__genmod
